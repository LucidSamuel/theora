  ...
  steps: [
    {
      ...
      demoAction: { type: 'LOAD_ATTACK_ROUND', payload: { round: 0, injectSpentMatch: false, focus: 'blinded-batch' } },
    },
    {
      ...
      demoAction: { type: 'LOAD_ATTACK_ROUND', payload: { round: 1, injectSpentMatch: false, focus: 'batch-size' } },
    },
    {
      ...
      demoAction: { type: 'LOAD_ATTACK_ROUND', payload: { round: 2, injectSpentMatch: false, focus: 'intersection' } },
    },
    {
      id: 'give-up',
